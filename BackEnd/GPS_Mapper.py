...
class GPSVis(object):
    ...
    def plot_map(self, output='save', save_as='Fire_Pattern_Predicted.png'):
        """
        ...
        if output == 'save':
           ...
           # plt.show()
        img_points = [] 
        if os.path.isfile('Fire_Pattern_Predicted.png'):
            imageob = Image.open('Fire_Pattern_Predicted.png').convert('RGB')
